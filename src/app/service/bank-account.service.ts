...
export class BankAccountService {
  ...
  transferMoney(sourceAccountId: number, destinationAccountId: number, amount: number): Observable<any> {
    const headers = this.getAuthHeaders();
    const params = new HttpParams()
      .set('sourceAccountId', sourceAccountId.toString())
      .set('destinationAccountId', destinationAccountId.toString())
